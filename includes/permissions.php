...
function permission_action_labels(): array
{
    return [
        ...
        // §21 Lead takip (follow-up) ince yetkileri
        'followup_view'     => 'Takip Görüntüle',
        'followup_create'   => 'Takip Oluştur',
        'followup_edit'     => 'Takip Düzenle',
        'followup_postpone' => 'Takip Ertele',
        'followup_complete' => 'Takip Tamamla',
        'followup_reassign' => 'Takip Yeniden Ata',
        'followup_reports'  => 'Gecikmiş Takip Raporu',
...
function module_action_registry(): array
{
    return [
        ...
        'orders'          => ['Siparişler',            'Satış',       ['view','create','edit','delete','status','print','pdf','mail']],
        ...
        'leads'           => ['Lead Yönetimi',         'Satış',       ['view','create','edit','delete','export','whatsapp','mail','scan','call','note','remind','assign','status','worklist','trash','restore','purge','import','settings','team_reminders','reports','followup_view','followup_create','followup_edit','followup_postpone','followup_complete','followup_reassign','followup_reports','notif_settings']],
        ...
        'email'           => ['E-Posta / Belge Gönderimi', 'Sistem',  ['manage','send_as_other','logs_view','resend','smtp_view','smtp_edit','templates_edit','departments']],
