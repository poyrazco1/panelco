...
function nav_sidebar_groups(): array
{
    return [
        ...
        'Satış / CRM' => [
            ...
            ['perm' => 'leads', 'title' => 'Lead Yönetimi', 'path' => 'modules/leads/index.php', 'icon' => 'user-check',
             'match' => ['prefix' => ['modules/leads/'],
                         'not_prefix' => ['modules/leads/my-lists', 'modules/leads/reminders', 'modules/leads/trash']]],
            ['perm' => 'leads', 'title' => 'Çalışma Listem', 'path' => 'modules/leads/my-lists.php', 'icon' => 'list-checks',
            ...
            ['perm' => 'product_lists', 'title' => 'Ürün Listeleri', 'path' => 'modules/product-lists/index.php', 'icon' => 'list-checks',
             'match' => ['prefix' => ['modules/product-lists/']]],
        ...
        'Teknik Servis' => [
            ...
            ['perm' => 'service', 'title' => 'Bakım Takipleri', 'path' => 'modules/maintenance/index.php', 'icon' => 'wrench',
             'match' => ['prefix' => ['modules/maintenance/']]],
    ...
    return [
        ...
        'Şirket & Görünüm' => [
            ...
            'cards' => [
                ...
                ['title' => 'Bildirim Tercihleri', 'icon' => 'bell', 'url' => 'modules/settings/notification-preferences.php',
                 'desc' => 'Lead takip bildirimleri, ses, dashboard kartı, yaklaşan/geciken uyarıları ve girişte özet. Kişiseldir.',
                 'kw' => 'bildirim tercih ses toast lead takip hatirlatma dashboard girisi kisisel notification'],
        ...
        'Teknik Servis Ayarları' => [
            ...
            'cards' => [
                ...
                ['title' => 'Bakım Hatırlatma Ayarları', 'icon' => 'wrench', 'perm' => 'settings', 'url' => 'modules/settings/maintenance-settings.php',
                 'desc' => 'Periyodik bakım süresi, hatırlatma aşamaları, e-posta/WhatsApp otomatik gönderim ve izin ayarları.',
                 'kw' => 'bakim maintenance hatirlatma periyot 6 ay servis whatsapp eposta izin'],
                ['title' => 'Bakım Mesaj Şablonları', 'icon' => 'mail', 'perm' => 'settings', 'url' => 'modules/settings/maintenance-templates.php',
                 'desc' => 'Periyodik bakım e-posta ve WhatsApp mesaj şablonlarını yönetin.',
                 'kw' => 'bakim maintenance sablon eposta whatsapp mesaj template'],
        ...
        'Lead / Tarama Ayarları' => [
            ...
            'cards' => [
                ...
                ['title' => 'Lead Durumları', 'icon' => 'list-checks', 'perm' => 'settings', 'url' => 'modules/settings/lead-statuses.php',
                 'desc' => 'Lead durum akışını (Yeni, Aranacak, Teklif, Dönüştü, Kara Liste…) yönetin; renk, sıra ve sonuç bayrakları.',
                 'kw' => 'lead durum status renk sira akis pipeline sonuc'],
        ...
        'Dış Ticaret Ayarları' => [
            'icon' => 'globe',
            'cards' => [
                ['title' => 'Mesaj Şablonları', 'icon' => 'message-circle', 'perm' => 'message_templates', 'url' => 'modules/international-customers/message-templates.php',
                 'desc' => 'Yurtdışı müşterilere satış/talep mail ve WhatsApp mesaj şablonları; değişkenli içerik.',
                 'kw' => 'mesaj sablon template mail whatsapp satis talep yurtdisi dis ticaret'],
                ['title' => 'Müşteri Durumları', 'icon' => 'list-checks', 'perm' => 'international_customers', 'url' => 'modules/international-customers/statuses.php',
                 'desc' => 'Yurtdışı müşteri durumlarını (potansiyel, müşteri, pasif vb.) tanımlayın ve renklendirin.',
                 'kw' => 'durum status yurtdisi musteri renk'],
                ['title' => 'Şirket Tipleri & Kategoriler', 'icon' => 'folder-tree', 'perm' => 'international_customers', 'url' => 'modules/international-customers/categories.php',
                 'desc' => 'Alıcı/Satıcı/Tedarikçi tipleri ve müşteri kategori ağacını yönetin.',
                 'kw' => 'sirket tip kategori alici satici tedarikci kategori agac'],
                ['title' => 'Dış Ticaret Gönderim Ayarları', 'icon' => 'sliders-horizontal', 'perm' => 'settings', 'url' => 'modules/international-customers/settings.php',
                 'desc' => 'Gönderen adı/WhatsApp numarası ve günlük mail gönderim limiti.',
                 'kw' => 'gonderim limit gunluk mail gonderen whatsapp imza'],
            ],
        ],
