...
/**
 * includes/icons.php
 * Panel genelinde TEK ikon sistemi (Lucide tabanlı, inline SVG).
 * Kullanım: echo icon('pencil');  echo icon('trash-2', 'icon-danger icon-sm');
 * Tüm ikonlar 24x24 viewBox, stroke=currentColor, aynı çizgi kalınlığı.
 */
    ...
    function icon(string $name, string $class = ''): string
    {
        ...
        if ($map === null) {
            $map = [
                ...
                'clipboard-plus'   => '<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M9 14h6"/><path d="M12 11v6"/>',
        ...
        return '<svg class="' . htmlspecialchars($cls, ENT_QUOTES) . '" viewBox="0 0 24 24" width="24" height="24"'
